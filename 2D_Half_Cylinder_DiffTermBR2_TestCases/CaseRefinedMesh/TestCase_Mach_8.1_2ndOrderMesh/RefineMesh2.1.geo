...
Point(5) = {7.70,0,0,cl};
Point(6) = {3.85,-3,0,cl};
Point(7) = {2.95,0,0,0.055};
Point(8) = {4.75,0,0,0.055};
Point(9) = {1.71, 0, 0, cl2}; //+0.1
Point(11) = {6, 0, 0, cl2}; //- 0.1
Point(14) = {1.4, 0, 0, cl1};
Point(15) = {6.30, 0, 0, cl1};
Point(16) = {3.85,-1.4,0,cl};

Point(17) = {3.85, 1.55, 0, cl2};
Point(26) = {3.85,1.39, 0, cl2};
Point(20) = {1.5, 0, 0, 0.035}; // +0.1
Point(21) = {6.2, 0, 0, 0.035}; // -0.1
Point(22) = {2.4, 0.95, 0, cl2};
Point(23) = {5.3, 0.95, 0, cl2};
Point(24) = {1.81, 0.46, 0, cl2};
Point(25) = {5.89, 0.46, 0, cl2};
Point(28) = {2.49, 0.85, 0, cl2};
Point(29) = {5.21, 0.85, 0, cl2};
...
Transfinite Line{-7,8} = 20 Using Progression 1.2;
